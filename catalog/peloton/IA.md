...
| Filter | Options |
|--------|---------|
| Category | Cycling, Running, Strength, Yoga, Meditation, Stretching, Cardio, Boxing, Rowing, Outdoor, Pilates, Barre |
| Duration | 5, 10, 15, 20, 30, 45, 60, 75, 90 minutes |
| Instructor | 40+ instructors by name |
| Difficulty | Beginner, Intermediate, Advanced |
| Music Genre | Pop, Rock, Hip Hop, EDM, Country, Latin, R&B, Classical, Indie |
| Subtitles | English, Spanish, German subtitles/captions |
| Equipment | None, weights, resistance bands, yoga block |
| Class Type | Live DJ, Live, Encore, On-demand |

## Metrics & Leaderboard

- **Output (kJ):** Total energy produced; primary competitive metric for cycling
- **Cadence (RPM):** Pedal speed; instructor calls target ranges
- **Resistance (%):** Difficulty level on the bike; 0-100 scale
- **Heart Rate (BPM):** Requires Bluetooth HR monitor; shown in 5 color-coded zones
- **Strive Score:** Heart rate zone-based effort score (like Orangetheory)
- **Leaderboard:** Real-time ranking against all riders in class (on-demand or live)
- **Personal Best:** PR badges when you beat your previous best output for that duration
- **Here Now:** See friends currently in the same live class
