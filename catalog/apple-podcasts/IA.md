...
podcasts.apple.com/settings  → Settings
podcasts.apple.com/account  → Account settings
podcasts.apple.com/account/security  → Security settings
/podcast/:name/reviews           → Show Reviews
/genre/:id/podcasts              → Genre Podcast List
/room/:id                        → Listening Room
podcastsconnect.apple.com/settings → Creator Settings
```
